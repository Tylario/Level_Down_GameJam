...
function determineTileType(floorNum, posX, posY, isCheckingBelow = false) 
{
	...
	switch (floorNum) {
		...
		case 16:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.20, posX, posY, floorNum, 0, 0.30, hexagonUnbreakable, "outer", objHexagonUnbreakable);
			break;
		case 17:
			crackedChance = 0
			trampolineChance = 0
		...
		case 18:
			...
			nothingChance = 0;  
			hologramSlowChance = 0; 
			tileType = perlinLevelGeneration(0.24, posX, posY, floorNum, 10, 0.22, hexagonIce, "half");
			break;
		case 19:
			crackedChance = 0
			trampolineChance = 0

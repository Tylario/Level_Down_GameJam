...
function determineTileType(floorNum, posX, posY, isCheckingBelow = false) 
{
	...
	switch (floorNum) {
		...
		case 14:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.26, posX, posY, floorNum, 100, 0.53, hexagonIce, "inner");
			break;
		case 15:
			tileType = hexagonUnbreakable;
			break;
		...
		case 18:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.45, posX, posY, floorNum, 0, 0.22, hexagonIce, "half");
			break;
		case 19:
			crackedChance = 0
			trampolineChance = 0
		...
		case 23:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.36, posX, posY, floorNum, 100, 0.73, hexagonIce, "inner");
			break;
		case 24:
			crackedChance = 0
			trampolineChance = 0
		...
		case 29:
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.42, posX, posY, floorNum, 55, 0.16, hexagonRandomFall, "half");
			break;
		case 30:
			tileType = hexagonUnbreakable;
			break;
		case 31:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.43, posX, posY, floorNum, 50, 0.2, hexagonBreakable, "inner");
			break;
		case 32:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0.25
			fallChance = 0
			tileType = perlinLevelGeneration(0.5, posX, posY, floorNum, 0, 0.1, hexagonBreakable, "inner");
			break;
		case 33:
			crackedChance = 0
			trampolineChance = 0
		...
		case 36:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.55, posX, posY, floorNum, 10, 0.1, hexagonUnbreakable, "outer");
			break;
		case 37:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.50, posX, posY, floorNum, 14, 0.64, hexagonBreakable, "half");
			break;
		case 38:
			crackedChance = 0
			trampolineChance = 0
		...
		case 41:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.54, posX, posY, floorNum, 5, 0.31, hexagonUnbreakable, "half");
			break;
		case 42:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.41, posX, posY, floorNum, 2, 0.71, hexagonBreakable, "outer");
			break;
		case 43:
			crackedChance = 0
			...
			iceChance = 1
			fallChance = 0.4
			tileType = perlinLevelGeneration(0.5, posX, posY, floorNum, 0, 0.30, hexagonIce, "inner");
			break;
		case 44:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 0.5
			tileType = perlinLevelGeneration(0.45, posX, posY, floorNum, 15, 0.80, hexagonRandomFall, "half");
			break;
		case 45:
			tileType = hexagonUnbreakable;
			break;
		case 46:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.45, posX, posY, floorNum, 0, 0.55, hexagonUnbreakable, "inner");
			break;
		case 47:
			crackedChance = 0.02
			trampolineChance = 0.008
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.63, posX, posY, floorNum, 123, 0.27, hexagonBreakable, "outer");
			break;
		case 48:
			crackedChance = 0
			trampolineChance = 0
		...
		case 49:
			...
			iceChance = 0.2
			fallChance = 1
			tileType = perlinLevelGeneration(0.6, posX, posY, floorNum, 0, 0.50, hexagonRandomFall, "inner");
			break;
		case 50:
			tileType = hexagonUnbreakable;
			break;
		case 51:
			...
			iceChance = 0
			fallChance = 0.25
			tileType = perlinLevelGeneration(0.57, posX, posY, floorNum, 0, 0.43, hexagonUnbreakable, "outer");
			break;
		case 52:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 0.4
			tileType = perlinLevelGeneration(0.50, posX, posY, floorNum, 0, 0.35, hexagonBreakable, "half");
			break;
		case 53:
			crackedChance = 0
			trampolineChance = 0
		...
		case 54:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.47, posX, posY, floorNum, 10, 0.08, hexagonIce, "inner");
			break;
		case 55:
			tileType = hexagonUnbreakable;
			break;
		case 56:
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.55, posX, posY, floorNum, 0, 0.04, hexagonRandomFall, "half");
			break;
		case 57:
			crackedChance = 0.015
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.6, posX, posY, floorNum, 0, 0.48, hexagonBreakable, "outer");
			break;
		case 58:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.50, posX, posY, floorNum, 0, 0.29, hexagonIce, "inner");
			break;
		case 59:
			crackedChance = 0.015
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.59, posX, posY, floorNum, 0, 0.58, hexagonBreakable, "inner");
			break;
		case 60:
			tileType = hexagonUnbreakable;
			break;
		...
		case 62:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.54, posX, posY, floorNum, 0, 0.47, hexagonBreakable, "inner");
			break;
		case 63:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.58, posX, posY, floorNum, 1, 0.52, hexagonIce, "half");
			break;
		case 64:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.55, posX, posY, floorNum, 0, 0.36, hexagonRandomFall, "inner");
			break;
		case 65:
			tileType = hexagonUnbreakable;
			break;
		case 66:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.55, posX, posY, floorNum, 10, 0.62, hexagonUnbreakable, "outer");
			break;
		case 67:
			crackedChance = 0.001
			trampolineChance = 0.003
			...
			iceChance = 0
			fallChance = 0.2
			tileType = perlinLevelGeneration(0.60, posX, posY, floorNum, 0, 0.39, hexagonBreakable, "half");
			break;
		case 68:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.66, posX, posY, floorNum, 0, 0.19, hexagonIce, "inner");
			break;
		case 69:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.70, posX, posY, floorNum, 0, 0.68, hexagonRandomFall, "inner");
			break;
		case 70:
			tileType = hexagonUnbreakable;
			break;
		...
		case 78:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.64, posX, posY, floorNum, 0, 0.75, hexagonIce, "inner");
			break;
		case 79:
			crackedChance = 0
			trampolineChance = 0.005
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.61, posX, posY, floorNum, 0, 0.42, hexagonRandomFall, "half");
			break;
		case 80:
			tileType = hexagonUnbreakable;
			break;
		...
		case 83:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.66, posX, posY, floorNum, 15, 0.66, hexagonIce, "half");
			break;
		case 84:
			crackedChance = 0
			trampolineChance = 0
		...
		case 86:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.53, posX, posY, floorNum, 0, 0.34, hexagonUnbreakable, "inner");
			break;
		case 87:
			crackedChance = 0
			trampolineChance = 0
		...
		case 88:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.62, posX, posY, floorNum, 236, 0.55, hexagonIce, "half");
			break;
		case 89:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0.8
			fallChance = 1
			tileType = perlinLevelGeneration(0.60, posX, posY, floorNum, 0.5, 0.23, hexagonRandomFall, "inner");
			break;
		case 90:
			tileType = hexagonUnbreakable;
			break;
		...
		case 93:
			...
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.66, posX, posY, floorNum, 10, 0.48, hexagonIce, "half");
			break;
		case 94:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.72, posX, posY, floorNum, 0, 0.40, hexagonRandomFall, "inner");
			break;
		case 95:
			tileType = hexagonUnbreakable;
			break;
...
function perlinLevelGeneration(difficulty, posX, posY, floorNum, seed, frequency, baseLevelTile, generationType) {
    ...
    if (generated) {
        ...
        var totalChance = crackedChance + trampolineChance + arrowChance + wallChance + breakableChance + unbreakableChance + iceChance + solidIceChance+ fallChance;

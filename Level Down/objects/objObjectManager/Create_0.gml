...
function determineTileType(floorNum, posX, posY, isCheckingBelow = false) 
{
	...
	switch (floorNum) {
		...
		case 16:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.30, posX, posY, floorNum, 0, 0.70, hexagonUnbreakable, "outer");
			break;
		case 17:
			crackedChance = 0
			trampolineChance = 0
		...
		case 18:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.30, posX, posY, floorNum, 10, 0.22, hexagonIce, "half");
			break;
		case 19:
			crackedChance = 0
			trampolineChance = 0
		...
		case 22:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.37, posX, posY, floorNum, 0, 0.28, hexagonBreakable, "half");
			break;
		case 23:
			crackedChance = 0
			...
			wallChance = 0
			breakableChance = 0
			unbreakableChance = 0.35
			breakIceChance = 0; 
			solidIceChance = 0; 
			iceChance = 1
			fallChance = 0
			tileType = perlinLevelGeneration(0.28, posX, posY, floorNum, 200, 0.73, hexagonIce, "inner");
			break;
		case 24:
			crackedChance = 0
			trampolineChance = 0
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.41, posX, posY, floorNum, 30, 0.35, hexagonRandomFall, "inner");
			break;
		case 25:
			tileType = hexagonUnbreakable;
			break;
		...
		case 27:
			...
			iceChance = 0
			fallChance = 0
			tileType = perlinLevelGeneration(0.35, posX, posY, floorNum, 200, 0.51, hexagonBreakable, "outer");
			break;
		case 28:
			crackedChance = 0
		...
		case 29:
			...
			iceChance = 0
			fallChance = 1
			tileType = perlinLevelGeneration(0.33, posX, posY, floorNum, 55, 0.16, hexagonRandomFall, "half");
			break;
		case 30:
			tileType = hexagonUnbreakable;
			break;
...
function perlinLevelGeneration(difficulty, posX, posY, floorNum, seed, frequency, baseLevelTile, generationType) {
    ...
    if (generated) {
        ...
        var totalChance = crackedChance + trampolineChance + arrowChance + wallChance + breakableChance + unbreakableChance + iceChance + solidIceChance + fallChance + breakIceChance;

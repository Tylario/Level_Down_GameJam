...
function determineTileType(floorNum, posX, posY, isCheckingBelow = false) 
{
	...
	switch (floorNum) {
		...
		case 1:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.16, posX, posY, floorNum, 157, 0.02, hexagonUnbreakable, "inner");
			break;
		case 2:
			crackedChance = 0
			trampolineChance = 0
			...
			nothingChance = 0;  
			hologramSlowChance = 0;
			tileType = perlinLevelGeneration(0.19, posX, posY, floorNum, 0, 0.02, hexagonUnbreakable, "inner");
			break;
		case 3:
			crackedChance = 0
			trampolineChance = 0
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.17, posX, posY, floorNum, 0, 0.05, hexagonUnbreakable, "inner");
			break;
		case 4:
			crackedChance = 0
			trampolineChance = 0
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.23, posX, posY, floorNum, 600, 0.1, hexagonBreakable, "half");
			break;
		case 5:
			lowGravityChance = 0; 
			tileType = hexagonUnbreakable;
		...
		case 6:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0;
			tileType = perlinLevelGeneration(0.25, posX, posY, floorNum, 340, 0.07, hexagonUnbreakable, "inner");
			break;
		case 7:
			crackedChance = 0
			trampolineChance = 0
		...
		case 16:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.20, posX, posY, floorNum, 0, 0.00030, hexagonUnbreakable, "outer", objHexagonUnbreakable);
			break;
		case 17:
			crackedChance = 0
			trampolineChance = 0
		...
		case 18:
			...
			nothingChance = 0;  
			hologramSlowChance = 0; 
			tileType = perlinLevelGeneration(0.24, posX, posY, floorNum, 10, 0.22, hexagonIce, "half", objHexagonUnbreakable);
			break;
		case 19:
			crackedChance = 0
			trampolineChance = 0
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.27, posX, posY, floorNum, 100, 0.33, hexagonBreakable, "inner", objHexagonUnbreakable, 0.2);
			break;
		case 20:
			tileType = hexagonUnbreakable;
			break;
		case 21:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.34, posX, posY, floorNum, 0, 0.000004, hexagonUnbreakable, "half", objHexagonUnbreakable, -0.1);
			break;
		case 22:
			crackedChance = 0
		...
		case 23:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.24, posX, posY, floorNum, 200, 0.13, hexagonIce, "inner", objHexagonUnbreakable);
			break;
		case 24:
			crackedChance = 0
			trampolineChance = 0
		...
		case 29:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.34, posX, posY, floorNum, 55, 0.16, hexagonRandomFall, "half", objHexagonHologramSlow, + 0.1);
			break;
		case 30:
			tileType = hexagonUnbreakable;
			break;
		...
		case 39:
			...
			hologramSlowChance = 0;
			lowGravityChance = 1; 
			tileType = perlinLevelGeneration(0.48, posX, posY, floorNum, 0, 0.25, hexagonBreakable, "inner", objHexagonUnbreakable, 0.05);
			break;
		case 40:
			tileType = hexagonUnbreakable;
			break;
		...
		case 42:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0, posX, posY, floorNum, 3, 0.31, hexagonBreakable, "outer", objHexagonHologramSlow);
			break;
		case 43:
			crackedChance = 0
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.55, posX, posY, floorNum, 405.7, 0.05, hexagonIce, "inner"); //402.4
			break;
		case 44:
			crackedChance = 0
			trampolineChance = 0
		...
		case 52:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.45, posX, posY, floorNum, 0, 0.035, hexagonBreakable, "half", objHexagonSolidIce);
			break;
		case 53:
			crackedChance = 0
			trampolineChance = 0
		...
		case 57:
			...
			hologramSlowChance = 0;
			lowGravityChance = 1;
			tileType = perlinLevelGeneration(0.45, posX, posY, floorNum, 1260, 0.01, hexagonBreakable, "half", objHexagonArrow);
			break;
		case 58:
			crackedChance = 0
			trampolineChance = 0
		...
		case 59:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.4, posX, posY, floorNum, 0, 0.058, hexagonBreakable, "inner");
			break;
		case 60:
			tileType = hexagonUnbreakable;
			break;
		case 61:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.35, posX, posY, floorNum, 0, 0.04, hexagonUnbreakable, "outer", objHexagonHologramSlow);
			break;
		case 62:
			crackedChance = 0.0
			trampolineChance = 0
		...
		case 63:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.5, posX, posY, floorNum, 1, 0.022, hexagonIce, "half");
			break;
		case 64:
			crackedChance = 0
			trampolineChance = 0
		...
		case 67:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0;
			tileType = perlinLevelGeneration(0.51, posX, posY, floorNum, 0, 0.05, hexagonBreakable, "half");
			break;
		case 68:
			crackedChance = 0
			trampolineChance = 0
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.6, posX, posY, floorNum, 0, 0.19, hexagonIce, "inner", objHexagonIce, 0.3);
			break;
		case 69:
			crackedChance = 0
			trampolineChance = 0
		...
		case 74:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.71, posX, posY, floorNum, 539.95, 0.17, hexagonUnbreakable, "half");
			break;
		case 75:
			tileType = hexagonUnbreakable;
			break;
		case 76:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.3, posX, posY, floorNum, 20, 0.24, hexagonUnbreakable, "inner");
			break;
		case 77:
			crackedChance = 0
			trampolineChance = 0
			...
			hologramSlowChance = 0;
			lowGravityChance = 0; 
			tileType = perlinLevelGeneration(0.5, posX, posY, floorNum, 0, 0.010, objHexagonHologramSlow, "outer", objHexagonHologramSlow);
			break;
		case 78:
			crackedChance = 0
			trampolineChance = 0
		...
		case 81:
			...
			hologramSlowChance = 0;
			lowGravityChance = 1; 
			tileType = perlinLevelGeneration(0.65, posX, posY, floorNum, 300, 0.15, objHexagonLowGravity, "half");
			break;
		case 82:
			crackedChance = 0.05
			trampolineChance = 0
		...
		case 83:
			...
			hologramSlowChance = 0;
			lowGravityChance = 0;
			tileType = perlinLevelGeneration(0.3, posX, posY, floorNum, 15, 0.066, hexagonIce, "half", objHexagonHologramSlow);
			break;
		case 84:
			crackedChance = 0
			trampolineChance = 0
		...
		case 87:
			...
			tileType = perlinLevelGeneration(0.55, posX, posY, floorNum, 0, 0.30, hexagonBreakable, "half");
			break;
		case 88:
			crackedChance = 0
			trampolineChance = 0.005
...
function perlinLevelGeneration(difficulty, posX, posY, floorNum, seed, frequency, baseLevelTile, generationType, overrideTile, offset = 0) {
    ...
    if (generated) {
		...
		custom_rng_set_seed(floorNum + seed + posX * 273 + posY * 541);
	    var randomChoice = custom_rng_float() * totalChance;
